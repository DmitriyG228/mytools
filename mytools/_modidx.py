...
d = { 'settings': { 'branch': '{branch}',
  ...
  'syms': { 'mytools.chatgpt': { 'mytools.chatgpt._ask_chatgpt': ('chatgptfuncs.html#_ask_chatgpt', 'mytools/chatgpt.py'),
            ...
            'mytools.llama': { 'mytools.llama.Accumulate2Graph': ('llama.html#accumulate2graph', 'mytools/llama.py'),
                               'mytools.llama.Accumulate2Graph.__init__': ('llama.html#__init__', 'mytools/llama.py'),
                               'mytools.llama.Accumulate2Graph._give_responses': ('llama.html#_give_responses', 'mytools/llama.py'),
                               'mytools.llama.Accumulate2Graph.aget_response': ('llama.html#aget_response', 'mytools/llama.py'),
                               'mytools.llama.Accumulate2Graph.get_response': ('llama.html#get_response', 'mytools/llama.py'),
                               'mytools.llama.CustomPrompt': ('llama.html#customprompt', 'mytools/llama.py'),
                               'mytools.llama.CustomPrompt.__init__': ('llama.html#__init__', 'mytools/llama.py'),
                               'mytools.llama.PandasReader': ('llama.html#pandasreader', 'mytools/llama.py'),
                               'mytools.llama.PandasReader.__init__': ('llama.html#__init__', 'mytools/llama.py'),
                               'mytools.llama.PandasReader.load_data': ('llama.html#load_data', 'mytools/llama.py'),
                               'mytools.llama.cos': ('llama.html#cos', 'mytools/llama.py'),
                               'mytools.llama.get_embedding': ('llama.html#get_embedding', 'mytools/llama.py')},

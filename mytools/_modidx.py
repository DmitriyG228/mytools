...
d = { 'settings': { 'branch': '{branch}',
                ...
                'lib_path': 'mytools'},
  'syms': { 'mytools.chatgpt': { 'mytools.chatgpt.ask_chatgpt': ('chatgptfuncs.html#ask_chatgpt', 'mytools/chatgpt.py'),
            ...
            'mytools.psql': { 'mytools.psql.current': ('psql.html#current', 'mytools/psql.py'),
                              'mytools.psql.docker_run': ('psql.html#docker_run', 'mytools/psql.py'),
